...
I hold a Master’s degree in Earth Resources Science and a Graduate Certificate in CyberGIS and Geospatial Data Science.   
...
<div style="text-align: center; margin-top: 40px;">
  <a href="assets/img/Power_Generation_Asia.jpg" class="glightbox" data-title="Appalachia Landform and Terrain Map">
    <img src="assets/img/Power_Generation_Asia.jpg" 
  ...
  <p style="text-align: left; max-width: 800px; margin: 10px auto 0; font-size: 0.9rem; line-height: 1.4;">
    This map compares how different classification methods such as Natural Breaks, Quantile, Equal Interval, and Unclassed Colors
